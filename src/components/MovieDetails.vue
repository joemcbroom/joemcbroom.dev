      ...
      <div class="ratings">
        <div v-for="rating in details.Ratings" :key="rating.Source" class="rating">
          ...
          <span class="value">
            ...
            <fresh-tomato
              v-if="rating.Source == 'Rotten Tomatoes' && getTomatometer(rating.Value) == 'fresh'"
              class="icon"
            />

            <rotten-tomato
              v-else-if="
                rating.Source == 'Rotten Tomatoes' && getTomatometer(rating.Value) == 'rotten'
              "
              class="icon"
            />
          </span>
...
<script>
import FreshTomato from '@/components/icons/FreshTomato';
import RottenTomato from '@/components/icons/RottenTomato';
export default {
