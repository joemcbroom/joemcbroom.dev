<template>
  <div id="movie-app">
    ...
    <div class="page-description">
      Vue app using
      <a target="_blank" href="http://www.omdbapi.com/">OMDb API</a> to search
      movies by title. <br />Built to showcase asynchronous data loading and
      Vue's transitions
      <a target="_blank" href="https://github.com/jumokee/joemcbroom.dev"
        >View on Github</a
      >
    </div>
    ...
    <div
      v-if="!error && Object.keys(movieList).length"
